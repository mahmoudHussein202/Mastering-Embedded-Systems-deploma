...
typedef struct
{
	uint16_t GPIO_PinNumber  ;   // Specifies the operating mode for the selected pin
								// This pararmeter must be set based on @ref GPIO_PINS_define

	uint8_t GPIO_MODE  ;   // Specifies the GPIO pins to be configured
									// This pararmeter can be a value of @ref GPIO_MODE_define

	uint8_t GPIO_Output_Speed ;   // Specifies the speed for the selected pin
									// This pararmeter can be a value of @ref GPIO_Speed_define
